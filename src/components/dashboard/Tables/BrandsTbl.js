...
//     ]
    ...
    const record = brandsData.slice(frstIndex, lasIndex)
    const npage = Math.ceil(brandsData.length / rcrdprpg)
    ...
    const csvData = [
        ...
        ...brandsData.map(({ Username, Name, Role, Email }) => [
            Username,
            Name,
            Role,
            Email
    ...
    const displayData = () => {
        if (isAdd === true) {
            return <AddorEditBrand id={0} />
        } else if (isEdit === true && iseidtId !== 0) {
            return <AddorEditBrand id={iseidtId} />
        }
    }
        ...
        <div>
            ...
            <div className='flex mt-5 flex-col md:flex-row  items-center justify-center md:justify-between mx-5'>
                ...
                <div className='flex items-center justify-center my-2 md:my-0'>
                    ...
                    <button onClick={() => { handleExportExcl(brandsData) }} className='flex border-[1px] px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col items-center justify-center'>
                                ...
                                <li className={` w-full py-1 ${col2 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol2(!col2) }}>Note</li>
