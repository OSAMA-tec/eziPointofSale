        ...
        <div className='w-full'>
            ...
            <div className='flex flex-col justify-center items-center mt-5 mx-5' ref={printRef} >
                <table id='usertbl' className="table-auto w-full mb-10  whitespace-no-wrap ">
                    <thead>
                        <tr>
                            {col1 && <th className=" py-2 title-font text-start tracking-wider font-medium text-gray-900 text-sm bg-gray-200">Product</th>}
                    ...
                    <tbody >
                        {record.map((value, index) => {
                            return <tr key={index} className={`${(index + 1) % 2 === 0 ? "bg-gray-200" : ""}`}>
                                ...
                                {col1 && <td className="px-1 py-1 text-start">{value.Name}</td>}
...
export default ProfitByProductTbl