                    ...
                    <table id='usertbl' className="table-fixed  mb-2   px-5 ">
                        <thead>
                            <tr className='h-[50px] bg-green-500'>
                                ...
                                <th className=" py-2 title-font  tracking-wider font-bold text-white text-sm ">Amount</th>
                                <th className=" py-2 title-font  tracking-wider font-bold text-white text-sm ">Payment mode</th>
                                <th className=" py-2 title-font  tracking-wider font-bold text-white text-sm ">Payment note</th>
