                    ...
                    <button onClick={() => { setColvis(!colvis) }} className='flex border-[1px] relative px-2 py-1 hover:bg-gray-400 border-gray-600 bg-gray-200 '>
                        ...
                        {colvis && <div className='absolute top-7 shadow-md shadow-gray-400 bg-white w-[150px]'>
                            <ul className='flex flex-col text-start px-2 justify-start'>
                                ...
                                <li className={` w-full py-[1px] ${col3 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol3(!col3) }}></li>
                                <li className={` w-full py-[1px] ${col4 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol4(!col4) }}></li>
                                <li className={` w-full py-[1px] ${col5 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol5(!col5) }}>Customer Name</li>
                                <li className={` w-full py-[1px] ${col6 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol6(!col6) }}>Contact ID</li>
                                <li className={` w-full py-[1px] ${col7 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol7(!col7) }}>Invoice No.</li>
                                <li className={` w-full py-[1px] ${col8 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol8(!col8) }}>Date</li>
                                <li className={` w-full py-[1px] ${col9 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol9(!col9) }}>Quantity</li>
                                <li className={` w-full py-[1px] ${col10 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol10(!col10) }}>Unit Price</li>
                                <li className={` w-full py-[1px] ${col11 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol11(!col11) }}>Discount</li>
                                <li className={` w-full py-[1px] ${col12 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol12(!col12) }}>Tax</li>
                                <li className={` w-full py-[1px] ${col13 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol13(!col13) }}>Price Inc. Tax</li>
                                <li className={` w-full py-[1px] ${col14 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol14(!col14) }}>Total</li>
                                <li className={` w-full py-[1px] ${col15 ? "" : "bg-blue-600"} hover:bg-blue-400 `} onClick={() => { setCol15(!col15) }}>Payment Method</li>
                ...
                <table id='usertbl'  className="table-fixed w-[115%] ">
                    <thead>
                        <tr className='h-[50px] bg-white text-sm px-1 text-center'>
                            {col1 && <th className=" py-2   border-l-[1px] border-r-[1px] border-gray-200  tracking-wider  text-gray-900 "> Product</th>}
                            {col2 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">SKU</th>}
                            {col3 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 "></th>}
                            {col4 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 "></th>}
                            {col5 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Customer Name</th>}
                            {col6 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Contact ID</th>}
                            {col7 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900  ">Invoice No.</th>}
                            {col8 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Date</th>}
                            {col9 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Quantity</th>}
                            {col10 && <th className=" py-2   border-l-[1px] border-r-[1px] border-gray-200  tracking-wider  text-gray-900 "> Unit Price</th>}
                            {col11 && <th className=" py-2   border-l-[1px] border-r-[1px] border-gray-200  tracking-wider  text-gray-900 "> Discount</th>}
                            {col12 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Tax</th>}
                            {col13 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Price Inc. Tax</th>}
                            {col14 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200  tracking-wider font-medium text-gray-900 ">Total</th>}
                            {col15 && <th className=" py-2 title-font border-l-[1px] border-r-[1px] border-gray-200   tracking-wider font-medium text-gray-900 ">Payment Method</th>}
                    ...
                    <tfoot>
                        <tr className='font-bold h-[50px] items-center bg-gray-400'>
                            <td colSpan={8} className='text-center border-l-[1px] border-r-[1px] border-white'>Total</td>
